...
if genai and GEMINI_API_KEY:
    try:
        ...
        # gemini-2.5-flash может быть недоступен в некоторых регионах/планах
        # пробуем flash, fallback на pro-exp
...
async def post_init(app):
    ...
    if gemini_model:
        logger.info(f"✅ Gemini ready: {getattr(gemini_model, 'model_name', 'gemini-2.5-flash')}")
    else:
